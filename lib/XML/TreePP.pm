...
This dereferences the character references, like &#xEB;, &#28450; etc.,
in XML document 

    $tpp->set( xml_deref => 1 );

Note that, for security reasons and your convenient, the entity references, 
&amp;, &lt;, &gt;, &apos; and &quot;, and the character references up to 
U+007F are dereferenced without xml_deref per default.
...
per default. This option forces to change or leave it.
